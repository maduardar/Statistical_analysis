...
Итак, мы [выяснили](#par2.2), что оценка счастья (Happiness score) коррелирует с ВВП на душу населения (GDP) и слабо зависит от щедрости (Generosity). Для наглядности, построим диаграммы рассеяния для этих двух пар показателей:
